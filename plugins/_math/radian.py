...
from .public import Num, format_num
...
class Rad:
    ...
    def __str__(self) -> str:
        ...
        return f"<{self.__class__.__name__} ({format_num(self.Get(), DIG)}pi) DEG({format_num(self.GetDeg(), DIG)}) 0x{id(self):X}>"
